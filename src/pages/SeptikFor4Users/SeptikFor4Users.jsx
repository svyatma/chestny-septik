...
function SeptikFor4Users() {
  ...
  return (
    <>
      <Helmet>
        <title>Купить автономный септик на 4 человека для частного дома и дачи по цене завода | Честный септик</title>
        ...
        <link rel="canonical" href="https://chestnyseptik.ru/septik-na-4-cheloveka" />
      </Helmet>
      ...
      <Section id="catalog">
        <div className="container">
          <SectionTitle>
            <span>Каталог автономных септиков на 4 человека</span>
          </SectionTitle>
        </div>
        <Catalog
      ...
      <Section id="faq">
        <SectionTitle
          variant="column"
        >
          <span>Часто задаваемые вопросы</span> об автономных септиках на 4 человека
        </SectionTitle>
        <Faq />
      </Section>
    </>
