...
function SeptikFor4Users() {
  const goToSection = useGoToSection();
  
  const serviceSchema = getServiceSchema({
    name: 'Установка септиков на 4 человека',
    serviceType: 'Монтаж автономных септиков',
    description: '+7 (812) 920-46-60 ✔ Выбирайте свой автономный септик для частного дома и дачи на 4 человека, а мы установим по цене производителя! Звоните!',
  ...
  return (
    <>
      <Helmet>
        <title>Автономные септики на 4 человека для частного дома и дачи по цене завода | Честный септик</title>
        <meta name="description" content="+7 (812) 920-46-60 ✔ Выбирайте свой автономный септик на 4 человека для дома, а мы установим по цене производителя! Звоните!" />
      ...
      <Hero>
        <div className="hero__septik-for">
          <h1 className="hero__septik-for-title column">
            <span>Септики на 4 человека</span> автономные и без откачки
          </h1>
          ...
          <Callout
            variant="septik-for"
            info="На этой странице Вы сможете выбрать свой автономный септик, который рассчитан до 4-х пользователей"
          />
      ...
      <Catalog
        ...
        initialQuantityValues={[4]}
      />
    </>
  );
}

export default SeptikFor4Users;